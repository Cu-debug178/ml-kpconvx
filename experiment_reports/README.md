...
Reusable failure-handling lessons for unattended experiment queues are recorded
in [`docs/EXPERIMENT_FAILURE_MEMORY.md`](../docs/EXPERIMENT_FAILURE_MEMORY.md).

## Index

| Dataset | Run | Main result | Status |
|---|---|---|---|
| S3DIS Area 5 | [KPConvX project history, seed 57106803](./s3dis/kpconvx-project-history-seed57106803/) | B1 scratch e180 completed without gain; DKS Phase-A active (2/18 verified, job 03 retry) | snapshot |
